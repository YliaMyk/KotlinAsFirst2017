 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = sagenes * 48 * 3 * 4.445 + arshins * 48 * 4.445 + vershoks*4.445
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double =  initial * (pow((1.0 + percent * 0.01) , 3.0))
/**
 * Простая
 *
